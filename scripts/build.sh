...
go build -ldflags "-X github.com/cgcardona/r-subnet-evm/plugin/evm.GitCommit=$SUBNET_EVM_COMMIT -X github.com/cgcardona/r-subnet-evm/plugin/evm.Version=$SUBNET_EVM_VERSION $STATIC_LD_FLAGS" -o "$BINARY_PATH" "plugin/"*.go
