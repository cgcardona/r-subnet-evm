...
```zsh
$ git clone https://github.com/cgcardona/r-subnet-evm.git
$ cd contracts
$ npm install
```
...
For more information about precompiles see [subnet-evm precompiles](https://github.com/cgcardona/r-subnet-evm#precompiles).

## Hardhat Config

Hardhat uses `hardhat.config.js` as the configuration file. You can define tasks, networks, compilers and more in that file. For more information see [here](https://hardhat.org/config/).

In Subnet-EVM, we provide a pre-configured file [hardhat.config.ts](https://github.com/cgcardona/r-subnet-evm/blob/master/contracts/hardhat.config.ts).
