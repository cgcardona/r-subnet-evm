...
func golangBindings(t *testing.T, overload bool) {
	...
	pwd, _ := os.Getwd()
	replacer := exec.Command(gocmd, "mod", "edit", "-x", "-require", "github.com/cgcardona/r-subnet-evm@v0.0.0", "-replace", "github.com/cgcardona/r-subnet-evm="+filepath.Join(pwd, "..", "..", "..")) // Repo root
	replacer.Dir = pkg
